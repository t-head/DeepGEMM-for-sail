...
int get_num_sms() {
    ...
    if (_num_sms == nullptr) {
        ...
        if (device_name.find("ZW810E") != std::string::npos || 
            device_name.find("ZW610E") != std::string::npos) {
            *_num_sms = 20;
        } else {
...
std::unordered_map<std::string, int> get_extra_info(int m = 0, int n = 0, int k = 0, int dtype = 1, const std::string& api_type = "dense") {

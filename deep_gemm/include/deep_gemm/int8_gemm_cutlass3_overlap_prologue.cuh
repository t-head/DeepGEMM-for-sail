...
CUTLASS_PRAGMA_UNROLL
      ...
      if (k_block == K_BLOCK_MAX - 2) {
        ...
        if (k_tile_count == 0 && scaleCopySendDone == false) {
...
public:
  ...
  operator()(Params const& params, char* smem_buf) {
    ...
    while (tile_valid) {
      ...
      int smem_pipe_scale = (smem_pipe_write + k_tile_count) % CollectiveMainloop_::DispatchPolicy::Stages;

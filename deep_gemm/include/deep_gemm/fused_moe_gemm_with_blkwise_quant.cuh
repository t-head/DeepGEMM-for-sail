...
bf16_blockwise_quant_gemm_fused_moe_kernel(const QuantGemmArgs args) {
...
public:
    ...
    static void run(DstT* gmem_d, SrcT* gmem_a, SrcT* gmem_b, float* gmem_sa, float* gmem_sb,
        ...
        auto device_func = bf16_blockwise_quant_gemm_fused_moe_kernel<SrcT, kGemmType, SHAPE_N, SHAPE_K, kNumGroups, BLOCK_M, BLOCK_N, BLOCK_K, WARP_M, WARP_N, BlockSize, kNumStages>;

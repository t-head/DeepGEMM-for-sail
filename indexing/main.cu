...
int main() {
    ...
    auto tma_a_desc = gemm_t::make_2d_tma_a_desc(reinterpret_cast<__hg_fp8_e4m3*>(0), m);
    auto tma_b_desc = gemm_t::make_2d_tma_b_desc(reinterpret_cast<__hg_fp8_e4m3*>(0));
    auto tma_d_desc = gemm_t::make_2d_tma_d_desc(reinterpret_cast<__ppu_bfloat16*>(0), m);
